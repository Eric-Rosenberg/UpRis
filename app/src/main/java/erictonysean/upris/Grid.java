...
//                        redArray[i2][i + 1] = redArray[i2][j];
//
//                for (int i2 = 0; i2 < numColumns; i2++)
//                    for (int j = i; j < numRows; j++) {
//                        greenArray[i][i + 1] = greenArray[i2][j];
//                    }
//
//                for (int i2 = 0; i2 < numColumns; i2++)
//                    for (int j = i; j < numRows; j++) {
//                        blueArray[i2][i + 1] = blueArray[i2][j];
//                    }
//
//                for (int i2 = 0; i2 < numColumns; i2++)
...
//
    ...
    private void moveRow(int row){
        boolean[][] tempRow = new boolean[numColumns][numRows];
        for(int i = 0; i < numColumns; i++){
            cellChecked[i][row - 1] = cellChecked[i][row];
        }
    }
    /* Remove a full row */
    //@param fullRow row to remove
    private void destroyFullRow(int fullRow){
        for(int i = 0; i < numColumns; i++){
            cellChecked[i][fullRow] = false;
        }
    }
